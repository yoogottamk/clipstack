...
from clipstack.constants import CLIPSTACK_WM_NAME, CLIPSTACK_SPY_WM_NAME, MAX_SIZE, Selection
...
class ClipboardSpy:
    ...
    def extract_selection_contents(self):
        ...
        selection_owner_wm_name = self.display.get_selection_owner(self.selection_atom).get_wm_name()
        ...
        for target_atom in available_targets:
            logger.debug("Extracting target %d[%s]", target_atom, self.display.get_atom_name(target_atom))
